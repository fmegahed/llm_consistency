...
```{r LLM_labels_distribution, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
# * Getting the Data ------------------------------------------------------
miamired = '#C3142D'
...
```{r distribution_NA_penalized, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
miamired = '#C3142D'
...
```{r binary_reliability_metrics, results='asis', message=FALSE}
pacman::p_load(irrCAC, stringr, tidyverse)
...
```{r intra_llm, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
library(grid)
library(gridExtra)
...
We study the inter-rater reliability among all models. 

```{r inter_llm, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
# ---- Setup ----
chat_models = c(
  "Top 2 Cheaper",
  "Top 2 Expensive",
...
The validity metrics for the binary classification experiment are visualized in the plots below.

```{r validity_StockNewsAPI, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
# ---- Setup ----
chat_models = c(
  "phi4-mini",
  "phi4:latest",
...
# extract the NA tickers (assuming tickers are in the same dataframe)
na_tickers = binary_gold_df |> 
  dplyr::filter(is.na(leading_news_effect)) |> 
  dplyr::pull(tickers) |> 
  unique()
...
cat(
  ...
  "\n\nThe missing or NA values are likely due to the fact that we could not retrieve stock prices for certain tickers from the Yahoo Finance API, possibly because they represent private stocks. The tickers associated with these missing values are:\n",
  paste(na_tickers, collapse = ", ")
)
...
```{r validity_SP500, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=8, fig.fullwidth=TRUE}
# ---- Setup ----
chat_models = c(
  "phi4-mini",
  "phi4:latest",
